...
class TopologyComponentMetrics extends Component {
  ...
  render () {
    ...
    let overviewMetrics = {}, timeSeriesMetrics = {},samplingVal= viewModeData.sampleTopologyLevel,
    ...
    if(!_.isEmpty(componentLevelActionDetails)){
      ...
      samplingVal = sampleObj !== undefined && sampleObj.enabled ? sampleObj.duration : viewModeData.sampleTopologyLevel;
    }
    return (
      <div>
