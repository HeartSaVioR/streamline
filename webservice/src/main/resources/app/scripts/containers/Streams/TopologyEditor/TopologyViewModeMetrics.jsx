...
@observer class TopologyViewModemetrics extends Component {
  ...
  render() {
    ...
    const latencyMetric = Utils.abbreviateNumber(overviewMetrics.latency);
    ...
    const emittedDiffMetric = Utils.abbreviateNumber(overviewMetrics.emitted - overviewMetrics.prevEmitted);
    const emittedDifference = emittedDiffMetric.value.toString();
    const latencyDiffMetric = Utils.abbreviateNumber(overviewMetrics.latency - overviewMetrics.prevLatency);
    const latencyDifference = latencyDiffMetric.value.toString();
    const ackedDiffMetric = Utils.abbreviateNumber(overviewMetrics.acked - overviewMetrics.prevAcked);
    ...
    const failedDifference = overviewMetrics.failed ? (overviewMetrics.failed - overviewMetrics.prevFailed).toString() : '0';
        ...
        <div className="clearfix topology-foot-top">
          ...
          <div className="topology-foot-widget">
              ...
              <h4>
                ...
                <small>{emittedDiffMetric.value <= 0 ? '' : '+'}
          ...
          <div className="topology-foot-widget">
              ...
              <h4>{latency} sec&nbsp;
                <small>{latencyDiffMetric.value <= 0 ? '' : '+'}
                  {latencyDifference}{latencyDiffMetric.suffix}
                </small>
              </h4>
          </div>
          <div className="topology-foot-widget">
              <h6>Failed <big>&nbsp;</big></h6>
